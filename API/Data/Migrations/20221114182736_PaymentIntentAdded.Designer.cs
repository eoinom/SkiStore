...
namespace API.Data.Migrations
{
    ...
    [Migration("20221114182736_PaymentIntentAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.OrderAggregates.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "30dc2acb-535d-4970-8724-5530d9f14f48",
                            Name = "Member",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "59bdec6a-9cd3-4d05-aea8-6d23df2cd0a0",
                            Name = "Admin",
            ...
            modelBuilder.Entity("API.Entities.OrderAggregates.UserAddress", b =>
                {
                    b.HasOne("API.Entities.User", null)
                        .WithOne("Address")
                        .HasForeignKey("API.Entities.OrderAggregates.UserAddress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
